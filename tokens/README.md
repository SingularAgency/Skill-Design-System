...
| `brand-web.css` | Profile **WEB** (marketing): primary azul/cyan `#4567ed`, surface negro dramático, escala azul/cyan. Dark-first. | No (vars puras) |
...
## Notas / pendientes
- ⚠️ **La escala azul/cyan** (`--singular-primary-*` en `brand-web.css`) fue **generada** desde `#4567ed`. Diseño debe validar los hex finales.
